  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container">
      <a href="#" class="navbar-brand d-flex align-items-center">
        ...
        <strong>Shuttle Bus UKDW</strong>
      </a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content rounded-3 shadow">
        <div class="modal-body p-4 text-center">
          <h5 class="mb-0">Mencari Bus?</h5>
          <p class="mb-0">Silahkan Pilih Asal Dan Tujuan </p>
        </div>
        <div class="mb-0">
          <label for="exampleFormControlInput1" class="form-label mb-0">Asal</label>
          <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Asal">
        </div>
        <div class="mb-0">
          <label for="exampleFormControlInput1" class="form-label mb-0">Tujuan</label>
          <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Tujuan">
        </div>
        <div class="d-grid gap-2 justify-content-sm-center">
          <label for="inputState" class="form-label">Jumlah Penumpang</label>
          <select id="inputState" class="form-select">
            <option selected disabled value="" class="">0</option>
            <option>1</option>
            <option>2</option>
            <option>3</option>
          </select>
        ...
        <button type="button" class="btn btn-lg btn-primary mt-5 w-100" data-bs-dismiss="modal">Cari Bus!</button>
...
</html><?php /**PATH C:\xampp\htdocs\UserInterface_RPL\resources\views/welcome.blade.php ENDPATH**/ ?>