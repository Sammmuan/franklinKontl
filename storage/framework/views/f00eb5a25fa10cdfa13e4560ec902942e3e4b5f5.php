...
<div class="container py-3">
  <header>
    ...
    <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
      <h1 class="display-4 fw-normal">Pemesanan Bus Institusi</h1>
      <div class="row g-3">
        <div class="col">
          <label for="">Dari</label>
          <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
            <option selected>Cari Asal</option>
        ...
        <div class="col">
          <label for="">Per Bus max 30 Orang</label>
          <input type="number" class="form-control" placeholder="Jumlah Bus" aria-label="Jumlah Bus">
        </div>
        <div class="col">
...
</html><?php /**PATH C:\xampp\htdocs\UserInterface_RPL\resources\views/institusi.blade.php ENDPATH**/ ?>